...
ER --> Error Rate 
separateInt --> Separate Intervals
...
x = np.array(pick_cv).reshape((-1, 1))
y = np.array(pick_er)
...
t = list(zip(pick_cv, pick_er))
xy_chart.add('CV-ER-int01 w/o outlier', [t[0],  t[1],  t[2],  t[3],  t[4],  t[5], 
                            t[6],  t[7],  t[8],  t[9],  t[10], t[11],  
                            t[12], t[13], t[14], t[15], t[16]])
xy_chart.add('Linear regression', [min(tups), max(tups)], stroke=True, stroke_style={'width': 3})
xy_chart.render()
xy_chart.render_to_file('CV_ER_int03_lin-regress_wo-outlier.svg')
...
r, p = stats.pearsonr(pick_cv, pick_er)
